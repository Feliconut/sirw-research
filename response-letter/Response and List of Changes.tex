...
\def\TBF#1{\textcolor{black}{#1}} %to be filled
\def\TBC#1{\textcolor{red}{#1}} %to be checked in the final one
...
%	as well as a copy of the original paper with revised potions highlighted in \edt{color}.
