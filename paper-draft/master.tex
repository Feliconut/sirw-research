...
\begin{document}
	...
	\begin{abstract}
		...
		The approach is to approximate the total drift experienced by the walker via using directed edge local times, described by the branching-like processes. The analysis depends on the diffusive approximation of the branching-like processes obtained in the Ray-Knight type framework.
