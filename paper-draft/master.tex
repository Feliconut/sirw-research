...
%\end{enumerate}	
		...
		In this section, we will prove the technical propositions in the proof of Theorem \ref{thm: main}.\edt{ We first prove Propositions \ref{lm: approx local drift by conditional means}, \ref{lm: approximation of means of local drift}, and therefore Proposition \ref{lm: control of acc drift}; then we prove \ref{lm: control of martingale}}. \TBD
